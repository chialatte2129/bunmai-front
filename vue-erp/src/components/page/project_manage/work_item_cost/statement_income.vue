<template>
    <div>
        ...
        width="250">
            <template slot-scope="scope">
                <span v-if="scope.row.level==1" style="font-weight:bolder;color:blue;font-size:20px">{{scope.row.title}}</span>
    ...
    <div style="width:90%;padding:5px 20px 20px 50px; height:50px;">
        <div style="width:50%;float:left;"><span style="color:red;font-size:25px;font-weight:bolder;">合計</span></div>
