<template>
    <div class="table">
        ...
        <el-dialog :title="$t('reimburse.edit_reimburse')" v-if="updateView" :visible.sync="updateView" width="1200px" :key="tbKey1" :before-close="cancelDialog" top="8%" 
...
export default {
    ...
    methods: {
        ...
        async getData(){
            ...
            var param = {
                ...
                filter:{
                    ...
                    is_current_sign:this.filter.is_current_sign
                }
            }
        ...
        async handleSyncTodo(){
            ...
            this.$emit('SyncTodo',{count:count})
        },
    }
}
</script>
